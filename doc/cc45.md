...
<declaration-statement> ::= ( "_Alignas" "(" ( <expression> | <type-specifier> "*"* ) ")" )? ( "volatile" )? <type-specifier> "*"* <identifier> ( "=" <expression> )? ";"
...
<member-declaration>    ::= ( "_Alignas" "(" ( <expression> | <type-specifier> "*"* ) ")" )? <type-specifier> "*"* <identifier> ";"
...
- **Control Flow**: `switch`, `case`, `default`, `goto`.
