...
- **Signedness**: All types default to **unsigned**. Signedness is supported via the `signed` keyword, which enables signed comparison logic (`cmp.s16`). Arithmetic currently remains unsigned-first (using standard Carry-based addition/subtraction).
