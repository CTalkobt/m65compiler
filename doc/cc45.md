...
- **Preprocessor**: `cc45` includes an integrated C preprocessor (`cp45`). It supports standard directives like `#include`, `#define`, `#if`, `#ifdef`, `#ifndef`, `#elif`, `#else`, and `#endif`. The preprocessor can also be invoked as a standalone tool via `bin/cp45`.
